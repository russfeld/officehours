...
class PostDeploy extends Command
{
    ...
    public function handle()
    {
        ...
        $settings_off = array("groupsessionenabled", "showmessage", "navbar_showflowcharts", "navbar_showcourses", "navbar_showhelp");
  ...
  <div class='panel panel-primary'>
    ...
    <div class='panel-body'>
      <ul>
        ...
        $editables = Editable::where('controller', 'GroupsessionController')->where('action', 'getHome')->where('key', 'home')->where('version', 0)->get();
        if($editables->count() == 0){
          $editable = new Editable;
          $editable->controller = "GroupsessionController";
          $editable->action = "getHome";
          $editable->key = "home";
          $editable->version = 0;
          $editable->user_id = 1;
          $editable->contents= "<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 bg-light-purple rounded'>
